...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL8="duration";
    public static final String COL9="repeatvalue";
    public static final String COL10="enddate";
    ...
    public boolean insertData (String activity, String category, String date,  String description, String color,String time,String duration, String enddate )
    {
        ...
        contentValues.put(COL8,duration);
//        contentValues.put(COL9,repeat);
        contentValues.put(COL9,enddate);
